...
@Component({
  selector: 'app-villa-sale-update',
  templateUrl: './villa-sale-update.component.html',
  styleUrls: ['./villa-sale-update.component.scss']
})
export class VillaSaleUpdateComponent extends BaseReUpdateComponent implements OnInit {
